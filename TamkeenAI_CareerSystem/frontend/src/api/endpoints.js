...
export const JOB = {
  ...
  AUTOMATE_APPLICATION: `${BASE_URL}/job/automate-application`,
  ...
  BATCH_APPLY: `${BASE_URL}/job/batch-apply`,
...
export const INTERVIEW = {
  ...
  SUBMIT_ANSWER: `${BASE_URL}/interview/submit-answer`,
  GET_FEEDBACK: (id) => `${BASE_URL}/interview/feedback/${id}`,
