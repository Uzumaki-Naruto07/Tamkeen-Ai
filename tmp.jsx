...
const widgetMap = {
  ...
  marketInsights: {
    ...
    defaultSize: { xs: 12, sm: 8, md: 8 },
    defaultOrder: 6
  },
  askTamkeen: {
    id: 'askTamkeen',
    title: 'Ask Tamkeen',
    component: AskTamkeenWidget,
    defaultSize: { xs: 12, sm: 4, md: 4 },
    defaultOrder: 7
  },
  opportunityAlerts: {
  ...
  learningProcess: {
    id: 'learningProcess',
    title: 'Learning process like how many video you finished?',
    component: LearningProcessCard,
    defaultSize: { xs: 12, sm: 4, md: 4 },
    defaultOrder: 9
  }
};
...
const Dashboard = () => {
  ...
  const setupDefaultLayout = () => {
    const defaultLayout = [
      ...
      'emiratiCareerPath', // Emirati career path
      'marketInsights',    // Market insights
      'askTamkeen',        // Ask Tamkeen chat
      'opportunityAlerts', // Opportunity alerts at bottom
      'learningProcess'    // Learning process at bottom left
    ];
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} md={8}>
          ...
          <Grid container spacing={2}>
            ...
            {/* Resume Score added below Calendar and Todo List */}
            <Grid item xs={12}>
              <Paper
                component={motion.div}
                initial={{ opacity: 0, y: 20 }}
            ...
            {/* Removing the duplicate Resume Score widget */}
          </Grid>
        </Grid>
                      ...
                      {(provided) => (
                        ...
                        >
                              ...
                              <Box sx={{ display: 'flex', gap: 0.5 }}>
                                ...
                                <Box sx={widget.id === 'applicationStats' ? 
